...
struct HitsCellTypes_Previews: PreviewProvider {
    static var previews: some View {
        HitsCellTypes(section: CategorySection(sectionTitle: "Горячие треки", cells: [CategoryCell(title: "", producerTitle: "", cover: "")]), cell: CategoryCell(title: "Тест", producerTitle: "Тест", cover: "harmony"))
    }
}
